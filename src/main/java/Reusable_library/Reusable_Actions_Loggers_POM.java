...
public class Reusable_Actions_Loggers_POM {
    ...
    public static void multipleMouseHover(WebDriver driver, List<WebElement> xpath, Integer number, ExtentTest logger, String elementName) throws InterruptedException {
        ...
        logger.log(LogStatus.INFO,"Hovering on element " + elementName);
        try{
            WebElement sendTab = wait.until(ExpectedConditions.visibilityOf((xpath.get(number))));
    ...
    //click by index, same as Multiple index
...
//This is the proper one
    ...
    //this is from yaseeen, dnt use it,ull get confused
